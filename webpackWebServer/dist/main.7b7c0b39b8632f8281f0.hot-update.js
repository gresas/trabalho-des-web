...
$(".thumbs-wrapper").on('click', '.btn', function () {
  ...
  if (thumbsList.hasClass('fa-solid')) {
    ...
    if (isPressedBtnRegular) {
      console.log(pressedBtn.parent().siblings('.wrapper').find('i').removeClass('fa-solid').addClass('fa-regular'));
    }
  } else {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("3957fd14e8881d51b314")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.7b7c0b39b8632f8281f0.hot-update.js.map