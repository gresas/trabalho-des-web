...
$(".thumbs-wrapper").on('click', '.btn', function () {
  ...
  if (thumbsList.hasClass('fa-solid')) {
    ...
    if (isPressedBtnRegular) {
      console.log(pressedBtn.parent().siblings('.wrapper').find('i'));
    }
  } else {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("7b7c0b39b8632f8281f0")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.6ba38418e21c148c2f71.hot-update.js.map